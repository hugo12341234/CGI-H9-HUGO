...
//For model
float	hombro = 0.0f, codo = 0.0f, mano = 0.0f, dedo1= 0.0f, falange1 = 0.0f, dedo2 = 0.0f, falange2 = 0.0f, dedo3 = 0.0f, falange3 = 0.0f;
//pivote hombro
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 modelTemp2 = glm::mat4(1.0f); //Temp      //para hacer pivotes



		//View set up 
		view = glm::translate(view, glm::vec3(movX,movY, movZ));
		view = glm::rotate(view, glm::radians(rot), glm::vec3(0.0f, 1.0f, 0.0f));   //rotacion de la vista en y
		...
		model = glm::translate(modelTemp2, glm::vec3(0.25f, 0.0f, 0.25f));
